...
You may want to scan all the objects in a bucket that have not complete-s3ly been scanned or were created
...
This tool will scan all objects that have not been complete-s3ly scanned in the bucket and invoke the lambda function
