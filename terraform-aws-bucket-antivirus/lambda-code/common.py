...
AV_STATUS_FULL = os.getenv("AV_STATUS_FULL", "av-full-scan")
...
AV_MOVE_INFECTED_FILES = os.getenv("AV_MOVE_INFECTED_FILES", "False")
AV_DEFINITION_FILE_PREFIXES = ["main", "daily", "bytecode"]
AV_DEFINITION_FILE_SUFFIXES = ["cld", "cvd"]
AV_BUCKETS_TO_SCAN = os.getenv("AV_BUCKETS_TO_SCAN")
AV_SCANNER_LAMBDA = os.getenv("AV_SCANNER_LAMBDA", "bucket-antivirus-scanner")
